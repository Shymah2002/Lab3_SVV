...
namespace SpecFlowCalculatorTests.Features
{
    ...
    public partial class UsingCalculatorDivisionFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UsingCalculatorDivision", "In order to perform divisions correctly\r\nAs a calculator user\r\nI want to divide t" +
                "wo numbers, including handling division by zero and the special case of 0 ÷ 0", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Divisions")]
        public async System.Threading.Tasks.Task DividingZeroByZero()
        {
            string[] tagsOfScenario = new string[] {
                    "Divisions"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Dividing zero by zero", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 25
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
